...
namespace AtlasOfRockPhysicsPlugin
{
    ...
    /// </summary>
    class CopyWellLogWithLinearTransformWorkstep : Workstep<CopyWellLogWithLinearTransformWorkstep.Arguments>, IExecutorSource, IAppearance, IDescriptionSource
    {
        ...
        protected override CopyWellLogWithLinearTransformWorkstep.Arguments CreateArgumentPackageCore(IDataSourceManager dataSourceManager)
        {
        ...
        public class CopyWellLogWithLinearTransformWorkstepDescription : IDescription
        {
            ...
            public string Name
            {
                get { return "CopyWellLogWithLinearTransmissionWorkstep"; }
            }
            /// <summary>
